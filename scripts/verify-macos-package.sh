...
for entry in bin/linklake-server bin/linklake-client launchd/com.linklake.server.plist launchd/com.linklake.update-resume.plist launchd/com.linklake.client.plist launchd/install-macos.sh README.md README.en.md CHANGELOG.md LICENSE NOTICE THIRD_PARTY_NOTICES.md THIRD_PARTY_LICENSES.html TRADEMARKS.md release.json; do
