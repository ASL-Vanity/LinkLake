...
try {
    ...
    foreach ($entry in @('linklake_manager.exe', 'flutter_windows.dll', 'data/app.so', 'data/icudtl.dat', 'README.md', 'README.en.md', 'MANAGER_README.md', 'LICENSE', 'NOTICE', 'release.json')) {
