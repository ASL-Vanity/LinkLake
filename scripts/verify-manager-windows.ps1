...
try {
    ...
    foreach ($entry in @('linklake_manager.exe', 'flutter_windows.dll', 'data/app.so', 'data/icudtl.dat', 'README.md', 'README.en.md', 'MANAGER_README.md', 'LICENSE', 'NOTICE', 'THIRD_PARTY_NOTICES.md', 'THIRD_PARTY_LICENSES.html', 'TRADEMARKS.md', 'release.json')) {
